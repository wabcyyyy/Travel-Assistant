...
`app/agent/tool_registry/__init__.py` 先导入 core 再导入本模块，因此任何
`from app.agent.tool_registry import registry` 拿到的都是登记完整的单例。
...
from app.agent.tool_registry.core import ToolSpec, registry
