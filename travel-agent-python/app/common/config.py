...
def _default_redis_url() -> str:
    """显式 REDIS_URL 优先，否则由 REDIS_HOST/REDIS_PORT 派生（Java 侧同口径）。"""
    return "redis://{}:{}/0".format(_get("REDIS_HOST", "localhost"), _get("REDIS_PORT", "6380"))
