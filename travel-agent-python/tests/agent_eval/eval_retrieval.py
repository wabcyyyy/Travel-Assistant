...
def main() -> int:
    ...
    parser.add_argument("--provider", default="hashed", choices=["hashed", "semantic"],
    ...
    print(json.dumps({"mode": f"offline-fixture-{provider.provider_name}", "case_count": len(results),
