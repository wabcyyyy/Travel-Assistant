...
def test_critic_reports_soft_quality_without_replacing_hard_validator():
    result = critique_plans([{"day_no": 1, "items": [
...
def test_critic_explains_empty_or_overloaded_days():
    result = critique_plans([{"day_no": 1, "items": []}, {"day_no": 2, "items": [
        {"item_type": "attraction", "poi_name": "A"}, {"item_type": "attraction", "poi_name": "B"},
        {"item_type": "attraction", "poi_name": "C"}, {"item_type": "attraction", "poi_name": "D"},
    ]}])
